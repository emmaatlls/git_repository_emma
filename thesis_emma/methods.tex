...
Community drop-out experiments were performed in a high-performance computing environment. Following the same procedure as for the complete communities (see Section \ref{sec:Construction and simulation of community models}), each of the 27 (\textit{Hv}SC1) and 26 (\textit{Hv}SC2) drop-out communities were built by omitting one strain at a time. Community and individual growth rates were compared across drop-outs.
