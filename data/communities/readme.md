# Readme communities folder

`dropouts` contains dropout communities sorted by HvSC1 and HvSC2. 
- The included csv files are the results from simulations of these dropouts
